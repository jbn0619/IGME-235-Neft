...
function fireBullet(e) {
    // let rect = app.lview.getBoundingClientRect();
    ...
    if (levelNum > 1) {
        let b1 = new Bullet(0xFFFF, ship.x - 7, ship.y);
        bullets.push(b1);
        gameScene.addChild(b1);
        let b2 = new Bullet(0xFFFF, ship.x, ship.y);
        bullets.push(b2);
        gameScene.addChild(b2);
        let b3 = new Bullet(0xFFFF, ship.x + 7, ship.y);
        bullets.push(b3);
